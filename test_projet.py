...
def plusieurs_tests(id_user, name_file_id, list_filtr, list_pond, nb_best):
    ...
    for filtr in list_filtr:
        for pond in list_pond:
            user_teammates = user_meetic.best_scores_file(name_file_id, filtr, pond, nb_best)
...
plusieurs_tests(76561198060771978, "list_gens_id_3.txt", [0.1, 0.01, 0.25, 0.5, 1], [1], 6)
